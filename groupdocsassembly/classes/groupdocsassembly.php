...
{ 
    ...
    /**
     * Creates a new object of type GroupDocsAssembly and shows it
     * @param int $user_id
     * @param string $value
     * @return GroupDocsAssembly
     */
    ...
    /**
     * Shows the data as GroupDocsAssembly with given id
    ...
    { 
        ...
        if ( $result instanceof GroupDocsAssembly ) 
            return $result; 
        else 
            return false; 
    }
    ...
    /**
     * Shows all the objects GroupDocsAssembly as object or array
     * @param int $asObject
     * @return array( GroupDocsAssembly )
     */ 
