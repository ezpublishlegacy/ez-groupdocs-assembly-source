...
'call_method' => array( 'include_file' => 'extension/groupdocsassembly/modules/groupdocsassembly/groupdocsassemblyfunctioncollection.php',
...
$FunctionList['list'] = array( 'name' => 'list', 
                               'operation_types' => array( 'read' ), 
                               'call_method' => array( 'class' => 'GroupdocsAssemblyFunctionCollection', 
                                                       'method' => 'fetchList' ), 
                               'parameter_type' => 'standard', 
